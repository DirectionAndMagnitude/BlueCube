...
#define CYBLE_LEDCAPSENSE_ANALOGIN_CHAR_INDEX   (0x02u) /* Index of analogIn characteristic */
#define CYBLE_LEDCAPSENSE_ANALOGIN_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_LEDCAPSENSE_ANALOGIN_AINCCCD_DESC_INDEX   (0x01u) /* Index of aincccd descriptor */
...
#define CYBLE_LEDCAPSENSE_ANALOGIN_DECL_HANDLE   (0x0014u) /* Handle of analogIn characteristic declaration */
#define CYBLE_LEDCAPSENSE_ANALOGIN_CHAR_HANDLE   (0x0015u) /* Handle of analogIn characteristic */
#define CYBLE_LEDCAPSENSE_ANALOGIN_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0016u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_LEDCAPSENSE_ANALOGIN_AINCCCD_DESC_HANDLE   (0x0017u) /* Handle of aincccd descriptor */
