    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x023Bu] = {
    /* Device Name */
    ...
    /* Characteristic User Description */
    (uint8)'a', (uint8)'n', (uint8)'a', (uint8)'l', (uint8)'o', (uint8)'g', (uint8)'I', (uint8)'n', (uint8)' ',
    (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'1', (uint8)'6',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* analogIn UUID */
    { 0x01FDu, (void *)&cyBle_attValues[47] }, /* analogIn */
    { 0x000Fu, (void *)&cyBle_attValues[556] }, /* Characteristic User Description */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* aincccd */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x17u] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0017u, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    ...
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0017u, {{0x0010u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0015u, 0x0000u /* analogIn                            */, 0x09120001u /* rd,ntf */, 0x0017u, {{0x01FDu, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0016u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0016u, {{0x000Fu, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0017u, 0x2902u /* aincccd                             */, 0x010A0101u /* rd,wr  */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesLen[16]}} },
};
